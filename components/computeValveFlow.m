...
##  p1 = 4*101325 ; % Primary (inlet) Pressure (Pa abs)
##  p2 = 1*101325 ; % Secondary (outlet) Pressure (Pa abs)
##  oD = 0.5; % Diameter of Orifice (mm)

% Returns flow through orifice in m3/s
function Qa = computeValveFlow(Ta, p1, p2, oD)
